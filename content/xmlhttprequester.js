function skiptco_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
skiptco_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				skiptco_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
...
skiptco_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
skiptco_xmlhttpRequester.prototype.setupRequestEvent =
